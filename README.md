...
```
dfx canister call opend listItem '(principal "wmio3-kqaaa-aaaaa-aaasq-cai", 70)'
```
...
```
const duxPrincipal = Principal.fromText("rrkah-fqaaa-aaaaa-aaaaq-cai");
```
